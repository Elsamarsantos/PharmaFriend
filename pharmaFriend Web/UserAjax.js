...
function createUser() {
    var newUser = {
        "userName":$("#userName").val(),"login": $("#login").val(),"passWord":$("#passWord").val(),"address":$("#address").val(),"lonLocation":$("#userlonLocation").val(),"latLocation":$("#userlatLocation").val()
    };
    console.log(newUser);
...
//         success: function (data) {
//             userLoggedIn=data;
//             $("#benvindo").html(`Welcome  ${userLoggedIn.userName}`);
//             home();
//         }
//     })
// };
